...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'medium', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 claude,endspace,example,fukasawa,fuwari,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '管理猿', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '历史上的今天', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.19870222.xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '历史, 博客', // 网站关键词 英文逗号隔开
